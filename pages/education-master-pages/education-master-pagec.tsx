...
export default function EducationMasterPageC() {
    ...
    return (
        <div className="lg:text-base md:text-lg sm:text-sm flex lg:flex-row flex-col p-[2rem] gap-[2rem] lg:h-[100%]">
            ...
            {/* Right Column */}
            <div className="flex lg:flex-row flex-col flex-1 justify-between lg:w-1/2 gap-[1rem]">
                <div className="lg:w-[50%]  gap-[1rem] text-justify h-[100%]" ref={divRef3}>
                    {part[2]}
                </div>
                <div className="flex flex-col lg:w-[50%]  gap-[1rem]">
                    <div className={`${styles.videoArea}`}>
                    ...
                    <div className="flex flex-col flex-1 text-justify mt-[1rem] h-[100%]" ref={divRef4}>
                        {part[3]}
                    </div>
                    <div className="border-t-4 border-b-4 border-r-0 border-l-0 m-auto justify-between">
                        <div className={`flex-1 text-center p-[2rem]`} style={{ position: "relative", fontFamily: "auto" }}>
                            <p
                                style={{
                                    position: "absolute",
                                    top: "70%",

...
export default function ThirdMasterPage() {
    ...
    return (
        <div className="flex lg:flex-row flex-col h-screen p-[2rem] gap-[2rem]" style={{ height: "100%", overflowY: "auto" }}>
            ...
            <div className="flex lg:flex-row flex-col flex-1 gap-[1rem] lg:w-1/2">
                <div className="flex flex-col flex-1 justify-between lg:w-1/4 text-2xl text-center" style={{ gap: "1rem" }}>
                    <div className="flex flex-1 text-center">
                        <div className={styles.mainBody} ref={divRef1}>
                ...
                <div className="flex flex-row flex-1 text-justify" style={{ height: "100%", gap: "2rem", fontSize: "1rem" }} ref={divRef2}>
                    {part[1]}
                </div>
            </div>
            ...
            {/* Right Column */}
            <div className="flex lg:flex-row flex-col flex-1 gap-[1rem] lg:w-1/2">
                <div className="flex flex-col flex-1 text-justify" style={{ gap: "1rem" }}>
                    <div className="h-[100%]" ref={divRef3}>
                        {part[2]}
                    </div>
                    <h2 className={`${styles.paragraphSubheading} pb-[1rem] pt-[1rem]`}>A Brief History of Shanghai</h2>
                    <div className={`${styles.dropCap} h-[100%]`} ref={divRef4}>
                        <span className={styles.firstLetter}>
                            S
                        </span>
                        {part[3]}
                ...
                <div className="flex flex-col items-center justify-center flex-1 gap-[1rem]">
                    <div className="flex flex-1 text-justify" ref={divRef5}>
                        {part[4]}
                    </div>
                    <div className={`${styles.videoArea} ${styles.videoArea1}`}>
                        <div>
            ...
            <div
                ref={hiddenRef}
                className="invisible absolute p-4 leading-normal text-black"
                style={{
                    height: '0px',
                    padding: '0px',
                    position: 'absolute',

...
export default function FirstMasterPage() {
  ...
  //     // setSize({
  //     //   width: divRef1.current.clientWidth,
  //     //   height: divRef1.current.clientHeight,
  //     // });
  //   }
  // }, []);
  ...
  return (
    <div className="flex lg:flex-row flex-col h-[100%] p-[2rem] gap-[2rem]" style={{ overflowY: "auto", fontSize: "1rem" }}>
      {/* Left Column */}
      <div className="flex lg:flex-row flex-col flex-1 lg:w-1/2 gap-[1rem]">
        <div className="flex flex-col gap-[1rem] lg:w-1/2">
          <div className="flex flex-col gap-[1rem]">
            <h1 style={{ fontSize: "2vw", color: "black", fontWeight: "700", textTransform: "uppercase", borderTop: "5px solid black", borderBottom: "1px solid black" }}>History</h1>
          ...
          <div className="flex text-justify h-[50dvh]" ref={divRef1}>
        ...
        <div className="text-justify lg:w-1/2" ref={divRef2}>
          {part[1]}
        </div>
      </div>
      {/* Right Column */}
      <div className="flex lg:flex-row flex-col flex-1 lg:w-1/2 gap-[1rem] text-justify">
        <div className="flex flex-1 flex-col gap-[1rem]">
          ...
          <div ref={divRef4} className="flex flex-1 h-[60dvh]">
            <div className={styles.dropCap}>
              <span className={styles.firstLetter}>
                S
              </span>
        ...
        <div className="flex flex-col flex-1 text-justify gap-[1rem] h-[100%]">
          <div className={`${styles.mainBody} h-[100%]`} ref={divRef5}>
            {part[4]}
          </div>
          <div className="flex items-center justify-center">
            <div className={`${styles.videoArea} ${styles.videoArea1}`}>
